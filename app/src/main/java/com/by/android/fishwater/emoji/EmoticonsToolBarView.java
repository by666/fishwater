...
public class EmoticonsToolBarView extends RelativeLayout implements IEmoticonsKeyboard {
    ...
    public EmoticonsToolBarView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.emoji_emoticonstoolbar, this);
    ...
    @SuppressLint("NewApi") private void scrollToBtnPosition(final int position){
    ...
    public void addData(int rec){
        if(ly_tool != null){
            ...
            View toolBtnView = inflater.inflate(R.layout.emoji_item_toolbtn,null);
    ...
    @SuppressLint("NewApi") public void addFixedView(View view , boolean isRight){
