                            ...
                            if (isChildCheck && emoticonBeanTemp != null) {
                                if (skeyName.equals("eventType")) {
                                    try {
                                        ...
                                        emoticonBeanTemp.setEventType(StringUtils.parseInt(value));
                             ...
                             */
                                ...
                                try {
                                    if (skeyName.equals("name")) {
                                        ...
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setLine(StringUtils.parseInt(value));
                                    } else if (skeyName.equals("row")) {
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setRow(StringUtils.parseInt(value));
                                    } else if (skeyName.equals("iconUri")) {
                                        String value = pullParser.nextText();
                                        ...
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setShowDelBtn(StringUtils.parseInt(value) == 1);
                                    } else if (skeyName.equals("itemPadding")) {
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setItemPadding(StringUtils.parseInt(value));
                                    } else if (skeyName.equals("horizontalSpacing")) {
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setHorizontalSpacing(StringUtils.parseInt(value));
                                    } else if (skeyName.equals("verticalSpacing")) {
                                        String value = pullParser.nextText();
                                        emoticonSetBean.setVerticalSpacing(StringUtils.parseInt(value));
                                    }
                                } catch (NumberFormatException e) {
                                }
                            }
