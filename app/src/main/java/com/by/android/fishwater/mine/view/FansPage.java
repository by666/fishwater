...
public class FansPage extends FWActivity implements IFansFollwerInterface{
    ...
    @ViewInject(R.id.recyclerview_fans)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        mPresenter = new FansFollowerPresenter(this,true);
        initView();
    }
