...
public class EmoticonsKeyBoardPopWindow extends PopupWindow {
    ...
    public EmoticonsKeyBoardPopWindow(Context context) {
        ...
        View mConentView = inflater.inflate(R.layout.emoji_keybord_pop_layout, null);
        int w = ((Activity) context).getWindowManager().getDefaultDisplay().getWidth();

        this.setContentView(mConentView);
        this.setWidth(w);
        this.setHeight(Utils.dip2px(context, 300));
        this.setAnimationStyle(R.style.SlideBottom2TopAnim);
        this.update();
    ...
    public void updateView(View view) {
        btn_write = (ImageView) view.findViewById(R.id.btn_emoji);
