...
public class EmoticonsPageView extends ViewPager implements IEmoticonsKeyboard, IView {
    ...
    private float mInitialMotionX=0;
    ...
    private void updateView() {
        ...
        for (EmoticonSetBean bean : mEmoticonSetBeanList) {
            ...
            if (emoticonList != null) {
                ...
                int itemHeight = Math.min((screenWidth - (bean.getRow() - 1) * Utils.dip2px(mContext, bean
                        .getHorizontalSpacing())) / bean.getRow(), (maxPagerHeight - (bean.getLine() - 1) * Utils
                        .dip2px(mContext, bean.getVerticalSpacing())) / bean.getLine());
                ...
                for (int i = 0; i < pageCount; i++) {
                    ...
                    if (bean.isShowDelBtn()) {
                        ...
                        list.add(new EmoticonBean(EmoticonBean.FACE_TYPE_DEL, "assets://emoji/emoji_del.png", null));
                    } else {
                        int count = bean.getLine() * bean.getRow();
...
//                if(Math.abs(x-mInitialMotionX)>0)
//                {
//                    return true;
//                }else
//                {
